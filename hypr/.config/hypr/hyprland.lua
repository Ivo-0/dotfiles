...
hl.bind(mainMod .. " + PRINT", hl.dsp.exec_cmd("hyprshot -m window -o /home/ivo/Screenshots"))
hl.bind("PRINT", hl.dsp.exec_cmd("hyprshot -m output -o /home/ivo/Screenshots"))
hl.bind(mainMod .. " + SHIFT + PRINT", hl.dsp.exec_cmd("hyprshot -m region -o /home/ivo/Screenshots"))
